package cn.qf.day06.demo03_generic.sample03_upbound
...
object UpBoundDemo {
  def main(args: Array[String]): Unit = {
    ...
    /*
    Error:(18, 17) type arguments [cn.qf.day06.demo03_generic.sample03_upbound.Lion]
    do not conform to method introducePet's type parameter bounds
    [T <: cn.qf.day06.demo03_generic.sample03_upbound.Pet]
    introducePet[Lion](Lion("大狮子"))
     */
  }
