package cn.qf.scala.day06.demo03_generic.sample04_downbound
...
object DownBoundDemo {
  def main(args: Array[String]): Unit = {
    ...
    /*
    Error:(18, 17) type arguments [cn.qf.scala.day06.demo03_generic.sample04_downbound.Lion]
     do not conform to method introducePet's type parameter bounds
     [T >: cn.qf.scala.day06.demo03_generic.sample04_downbound.Cat]
    introducePet[Lion](Lion("大狮子"))
     */
  }
